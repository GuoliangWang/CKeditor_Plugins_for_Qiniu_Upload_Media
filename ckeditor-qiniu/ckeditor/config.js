CKEDITOR.editorConfig = function( config ) {
	config.plugins = 'dialogui,dialog,a11yhelp,autogrow,dialogadvtab,basicstyles,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,templates,menu,contextmenu,resize,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,font,format,htmlwriter,wysiwygarea,image,imagepaste,indent,indentblock,indentlist,justify,fakeobjects,link,list,maximize,pastetext,pastefromword,removeformat,sourcearea,table,tabletools,undo,notification,liststyle,lineutils,widget,filetools,notificationaggregator,uploadwidget,uploadimage,codesnippet';
	config.skin = 'moono';
