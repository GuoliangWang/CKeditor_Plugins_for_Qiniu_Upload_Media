...
( function() {
	...
	CKEDITOR.plugins.add( 'embed_qiniu', {
		icons: 'embed_qiniu', // %REMOVE_LINE_CORE%
		hidpi: true, // %REMOVE_LINE_CORE%
		requires: 'embedbase_qiniu',

		init: function( editor ) {
			var widgetDefinition = CKEDITOR.plugins.embedBaseQiniu.createWidgetBaseDefinition( editor );

			// Extend the base definition with additional properties.
			CKEDITOR.tools.extend( widgetDefinition, {
				// Use a dialog exposed by the embedbase_qiniu plugin.
				dialog: 'embedBaseQiniu',
				button: editor.lang.embedbase_qiniu.button,
			...
			editor.widgets.add( 'embed_qiniu', widgetDefinition );
